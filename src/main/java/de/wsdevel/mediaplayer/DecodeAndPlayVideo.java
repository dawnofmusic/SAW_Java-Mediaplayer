...
public class DecodeAndPlayVideo {
	...
	final String filename = "run/devel/contents/sintel_trailer-480p.mp4";
	...
	while (container.readNextPacket(packet) >= 0) {
		...
		while (offset < packet.getSize()) {
			...
			// * in different units depending on your IContainer,
			// and
			...
			// .currentTimeMillis();
			// final long millisecondsClockTimeSinceStartofVideo =
			...
			// final double millisecondsStreamTimeSinceStartOfVideo
			// = (picture
			// .getTimeStamp() - firstTimestampInStream) / 1000d;
			// // final long millisecondsTolerance = 50; // and we
			// // // give
			// // // ourselfs
			// // // 50 ms of
			// // // tolerance
			// final long millisecondsToSleep = Math
			// .round((millisecondsStreamTimeSinceStartOfVideo -
			// (millisecondsClockTimeSinceStartofVideo)));
			// if (millisecondsToSleep > 0) {
			// try {
			// Thread.sleep(millisecondsToSleep / 100);
